...
def run_lemma_baseline (dataframes, names=[], output_path='..\\resources\\output\\'):
    ...
    for df, name in zip(dataframes, names):
        ...
        result.to_csv(output_path + 'lemma_baseline-' + name + '.csv')
    ...
    metrics_df.to_csv(output_path + 'lemma_baseline-metrics.csv')
...
if __name__ == '__main__':
    ...
    run_lemma_baseline(dataframes=[daganlevy, zeichner], names=['daganlevy', 'zeichner'])